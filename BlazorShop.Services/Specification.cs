namespace BlazorShop.Services {
    ...
    internal abstract class Specification<T> where T : class {
        ...
        protected Specification() => this.cacheKey = new() { this.GetType().Name };
        ...
        public virtual bool IsSatisfiedBy(T value) {
            ...
            var func = DelegateCache.GetOrAdd(string.Join(string.Empty, this.cacheKey),
